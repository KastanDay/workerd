...
export type Ai_Cf_Zai_Org_Glm_5_3_Reasoning_Effort = "low" | "medium" | "high" | "max" | null;
export type Ai_Cf_Zai_Org_Glm_5_3_Chat_Options = Omit<
  ChatCompletionsCommonOptions,
...
export type Ai_Cf_Zai_Org_Glm_5_3_Prompt = Ai_Cf_Zai_Org_Glm_5_3_Chat_Options & {
  prompt: string;
  messages?: never;
  input?: never;
};
export type Ai_Cf_Zai_Org_Glm_5_3_Messages = Ai_Cf_Zai_Org_Glm_5_3_Chat_Options & {
  messages: Array<ChatCompletionMessageParam>;
  prompt?: never;
  input?: never;
};
export type Ai_Cf_Zai_Org_Glm_5_3_Responses = Omit<ResponsesInput, "input" | "reasoning"> & {
  input: string | ResponseInput;
  reasoning?:
...
export type Ai_Cf_Zai_Org_Glm_5_3_Input =
